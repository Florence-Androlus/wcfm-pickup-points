(function($){
    ...
    $(document).on('change', '#wcfmmp_pickup_store_day, #wcfmmp_pickup_store_status, #wcfmmp_pickup_store_orderby', function(){
        var fandpipo_pickup_day = $('#wcfmmp_pickup_store_day').val();
        var fandpipo_pickup_status = $('#wcfmmp_pickup_store_status').val();
        var fandpipo_pickup_orderby = $('#wcfmmp_pickup_store_orderby').val();
        ...
        $.ajax({
            ...
            data: {
                ...
                security: fandpipo_data.nonce,
                fandpipo_pickup_day: fandpipo_pickup_day,
                fandpipo_pickup_status: fandpipo_pickup_status,
                fandpipo_pickup_orderby: fandpipo_pickup_orderby,
            },
