=== Pickup Points : Ultimate Edition - FAND Addon ===
...
Pickup Points : Ultimate Edition - FAND Addon is a powerful extension for WCFM Marketplace. It gives vendors the ability to create and manage their own pickup points independently. 
...
1. Upload the plugin files to the `/wp-content/plugins/pickup-points-ultimate` directory, or install the plugin through the WordPress plugins screen directly.
