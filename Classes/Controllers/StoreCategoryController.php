...
class StoreCategoryController {
     ...
     */
    public function fandpipo_saveVendorCategories($vendor_id, $wcfm_settings_form) {
     ...
     */
    public static function fandpipo_getVendorCategories($vendor_id) {
     ...
     */
    public function fandpipo_ajaxGetCategories() {
        // 1. Vérification du Nonce
        check_ajax_referer('fandpipo_get_categories_nonce', 'security');
        ...
        $categories = self::fandpipo_getVendorCategories($vendor_id);
